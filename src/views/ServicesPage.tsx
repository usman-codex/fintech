    ...
    return (
      <div className="min-h-screen bg-[#FAFDFE] text-[#1A314C] pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-16">
          ...
          <div className="bg-gradient-to-r from-[#1A314C] via-[#10566E] to-[#107C8E] rounded-3xl p-8 sm:p-12 text-white border border-[#107C8E]/40 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-3 max-w-xl text-center md:text-left">
              ...
              <p className="text-xs sm:text-sm text-[#C9E5ED] leading-relaxed font-sans">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                onClick={onContactUs}
                className="px-6 py-3.5 rounded-2xl bg-[#1DA5B8] hover:bg-[#107C8E] text-[#1A314C] hover:text-white font-extrabold text-xs sm:text-sm transition-all shadow-lg cursor-pointer flex items-center gap-2 font-heading"
              >
          ...
          {/* Other Services Grid */}
          <div className="space-y-6 pt-8 border-t border-[#C9E5ED]">
            <h4 className="text-lg font-bold text-[#1A314C] font-heading">Explore Other Specialized Services</h4>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
              {SERVICES_DATA.filter((s) => s.id !== currentService.id).map((other) => (
                <button
                  key={other.id}
                  onClick={() => onSelectService(other)}
                  className="bg-white p-5 rounded-2xl border border-[#C9E5ED] hover:border-[#1DA5B8] text-center flex flex-col items-center gap-3 group transition-all cursor-pointer shadow-xs hover:shadow-md"
                >
                  ...
                  <span className="text-xs font-bold text-[#1A314C] group-hover:text-[#107C8E] transition-colors line-clamp-2 font-heading">
                    {other.shortTitle}
                  </span>
                </button>
              ))}
